...
/*   Updated: 2022/10/17 17:47:59 by jecontre         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
/* LIBRARY
   ...
   RETURN VALUES
	 ...
	 Toman el tamaño completo del búfer de destino y garantizan la terminación 
	 NUL si hay espacio.  Tenga en cuenta que espacio para el NUL debe incluirse 
	 en dstsize.
	 strlcat() añade la cadena src al final de dst.  Añadirá como máximo
     como máximo dstsize - strlen(dst) - 1 caracteres
*/
