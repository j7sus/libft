...
/*   Updated: 2023/05/10 13:46:55 by jecontre         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* ----------------------------------------------------------------------------
  La funcion strchr busca la primera aparicion del caracter 'c' (un char sin 
  signo) en la cadena apuntada por el argumento *s
  Devuelve un puntero de la primera aparicion del caracter 'c' a la cadena 's'
  o NULL si no se encuentra el caracter
